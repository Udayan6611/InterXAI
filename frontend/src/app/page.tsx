      ...
      <nav className="absolute top-0 inset-x-0 z-50 bg-transparent">
        <div className="max-w-[1400px] mx-auto px-8 h-24 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-[22px] tracking-tight text-slate-800">InterXAI</span>
          </div>

          <div className="hidden md:flex items-center gap-10 font-semibold text-[14px] text-slate-600">
            <Link href="#" className="hover:text-blue-600 transition-colors flex items-center gap-1">Solutions <span className="text-[10px]">▼</span></Link>
            <Link href="#" className="hover:text-blue-600 transition-colors">How It Works</Link>
            <Link href="#" className="hover:text-blue-600 transition-colors">For Users</Link>
            <Link href="#" className="hover:text-blue-600 transition-colors">Pricing</Link>
            <Link href="#" className="hover:text-blue-600 transition-colors flex items-center gap-1">Resources <span className="text-[10px]">▼</span></Link>
          </div>

          <div className="flex items-center gap-6">
            <Link href="/auth/signin" className="hidden sm:block text-[15px] font-bold text-slate-700 hover:text-blue-600 transition-colors">
              Sign In
            </Link>
            <Link href="/auth/signup" className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2.5 rounded-full text-[14px] font-bold transition-all flex items-center gap-2 shadow-[0_8px_20px_rgba(59,130,246,0.3)]">
        ...
        <div className="w-full flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="relative z-20 w-full lg:w-[45%]">
            ...
            >
              ...
              <span className="text-[12px] font-bold tracking-wide uppercase">AI-Powered Interview Platform</span>
            </motion.div>
            ...
            >
              Ace <span className="text-blue-600">Interviews.</span><br />
              Advance Your<br />
              Career.
            </motion.h1>
            ...
            >
              InterXAI conducts intelligent interviews, evaluates skills, and delivers actionable feedback to help you get hired faster and grow your career.
            </motion.p>
            ...
            >
              <Link href="/auth/signup" className="group bg-[#2563eb] hover:bg-blue-700 text-white pl-6 pr-2 py-2 rounded-full text-[15px] font-bold transition-all flex items-center gap-4 shadow-[0_10px_30px_rgba(37,99,235,0.4)]">
                Start AI Interview
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-[18px] font-extrabold text-slate-800">10,000+</div>
                  <div className="text-[11px] font-bold text-slate-400">Interviews Run</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-[18px] font-extrabold text-slate-800">82%</div>
                  <div className="text-[11px] font-bold text-slate-400">Avg. Confidence Score</div>
                </div>
              </div>
              <div className="w-px h-10 bg-slate-200" />
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-[18px] font-extrabold text-slate-800 flex items-baseline gap-1">4.9<span className="text-[12px] text-slate-400">/5</span></div>
                  <div className="text-[11px] font-bold text-slate-400">User Rating</div>
                </div>
              </div>
            </motion.div>
          </div>
            ...
            >
              ...
              <motion.div
                ...
                style={{
                  ...
                  boxShadow: "0 25px 50px -12px rgba(15, 23, 42, 0.08), inset 0 1px 2px rgba(255, 255, 255, 0.5)",
                  transform: "rotateY(16deg) rotateX(8deg)",
                  transformStyle: "preserve-3d"
                }}
                whileHover={{ transform: "rotateY(8deg) rotateX(4deg) translateZ(30px)", scale: 1.03 }}
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <div className="text-[14px] font-extrabold text-slate-800">AI Interviewer</div>
                    <div className="flex items-center gap-1.5 mt-0.5">
                      <div className="w-2 h-2 rounded-full bg-blue-500 shadow-[0_0_6px_#3b82f6]" />
                      <span className="text-[12px] font-bold text-slate-400">Listening...</span>
                    </div>
                  </div>
                </div>
                {/* Thin beautiful SVG line soundwave */}
                <svg className="w-full h-8 mt-4 stroke-blue-500/40 fill-none" viewBox="0 0 200 40">
                  <motion.path
                    animate={{
                      d: [
              ...
              <motion.div
                ...
                whileHover={{ transform: "rotateY(8deg) rotateX(5deg) translateZ(30px)", scale: 1.03 }}
              ...
              >
                <span className="text-[12px] font-extrabold text-slate-500 mb-4 self-start">Confidence Score</span>
                <div className="relative w-[100px] h-[100px] flex items-center justify-center mb-4">
                  <svg className="w-full h-full transform -rotate-90">
                    <circle cx="50" cy="50" r="42" className="stroke-slate-200/40" strokeWidth="8" fill="none" />
                    <circle cx="50" cy="50" r="42" className="stroke-[#0ea5e9]" strokeWidth="8" fill="none" strokeDasharray="263" strokeDashoffset="47" strokeLinecap="round" />
                  </svg>
                  <div className="absolute text-[26px] font-extrabold text-slate-800 tracking-tight">82<span className="text-[14px] text-blue-500 font-bold">%</span></div>
                </div>
                {/* Smooth Rising Sparkline SVG */}
                <svg className="w-full h-10 mt-3" viewBox="0 0 100 30" preserveAspectRatio="none">
                  <path d="M0,22 C15,20 30,12 45,18 C60,24 75,6 100,2" fill="none" className="stroke-blue-400" strokeWidth="2.2" strokeLinecap="round" />
                </svg>
              </motion.div>
              ...
              >
                <div className="flex items-center justify-between mb-5">
                  <span className="font-extrabold text-[15px] text-slate-800">Feedback</span>
                  <Sparkles className="w-4 h-4 text-blue-500" />
                </div>
                <div className="space-y-3.5">
                  {['Clear Answers', 'Good Structure', 'Relevant Examples', 'Keep Improving'].map((text, i) => (
              ...
              >
                <span className="text-[13px] font-extrabold text-slate-800 mb-4 block">Skills Detected</span>
                <div className="flex flex-wrap gap-2">
                  <span className="px-3.5 py-1.5 bg-slate-50/20 border border-slate-300/30 rounded-full text-[12px] font-bold text-slate-700">Problem Solving</span>
                  <span className="px-3.5 py-1.5 bg-slate-50/20 border border-slate-300/30 rounded-full text-[12px] font-bold text-slate-700">Communication</span>
                  <span className="px-3.5 py-1.5 bg-slate-50/20 border border-slate-300/30 rounded-full text-[12px] font-bold text-slate-700">Leadership</span>
                  <span className="px-3.5 py-1.5 bg-slate-50/20 border border-slate-300/30 rounded-full text-[12px] font-bold text-slate-700">Adaptability</span>
                  <span className="px-3.5 py-1.5 bg-blue-100/60 border border-blue-200/50 rounded-full text-[12px] font-extrabold text-blue-800">+12</span>
                </div>
              </motion.div>
      ...
      <section className="relative z-10 w-full max-w-[1400px] mx-auto px-8 pb-10">
        <div className="bg-white/60 backdrop-blur-xl border-[1.5px] border-white shadow-[0_10px_30px_rgba(15,23,42,0.03)] px-10 py-8 rounded-[30px] flex flex-col md:flex-row items-center justify-between gap-10 flex-wrap">
          ...
          <div className="flex items-center justify-between gap-10 flex-wrap flex-1 opacity-70 grayscale hover:grayscale-0 transition-all duration-500 text-slate-800">
            <div className="font-extrabold text-[26px] tracking-tight">Google</div>
            <div className="font-bold text-[22px] flex items-center gap-1.5"><div className="grid grid-cols-2 gap-[2px]"><div className="w-3 h-3 bg-current" /><div className="w-3 h-3 bg-current" /><div className="w-3 h-3 bg-current" /><div className="w-3 h-3 bg-current" /></div> Microsoft</div>
            <div className="font-bold text-[28px] tracking-tighter">amazon</div>
            <div className="font-bold text-[26px] tracking-tight hover:text-[#ff5a5f] transition-colors">airbnb</div>
            <div className="font-bold text-[26px] tracking-tight flex items-center gap-1.5"><span className="text-3xl font-light">∞</span> Meta</div>
            <div className="font-bold text-[24px] tracking-tighter flex items-center gap-1.5"><div className="w-7 h-7 rounded-full bg-slate-800 text-white flex items-center justify-center text-[10px] hover:bg-[#1ed760] transition-colors">(((</div> Spotify</div>
          </div>
        </div>
      </section>
